...
figure_gl::figure_gl(QObject *parent)
	: figure(parent)
{
	rotate_cnt = 4;
	figureState(0);
...
void figure_gl::figureState(int state)
{
	blocks.clear();

	block* __blk1 = new block(this);
	__blk1->setColor(Qt::cyan);

	block* __blk2 = new block(this);
	__blk2->setColor(Qt::cyan);

	block* __blk3 = new block(this);
	__blk3->setColor(Qt::cyan);

	block* __blk4 = new block(this);
	__blk4->setColor(Qt::cyan);
